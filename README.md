...
This is a sample template for sessionProject - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sessionproject --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sessionproject
```
